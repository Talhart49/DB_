...
public class UDChef_D extends JFrame {
    ...
    private void initComponents() {
        ...
        Uidfld.setBounds(210, 268, 154, 30);
        PUD.add(Uidfld);
        ...
        emailfld.setBounds(210, 318, 154, 30);
        PUD.add(emailfld);
        ...
        Uemaillbl.setBounds(53, 322, 147, 22);
        PUD.add(Uemaillbl);
        ...
        updatebtn.setBounds(214, 374, 110, 30);
        PUD.add(updatebtn);
        ...
        Cheflbl.setFont(new Font("Tahoma", Font.BOLD | Font.ITALIC, 22));
        Cheflbl.setBounds(583, 153, 180, 40);
        PUD.add(Cheflbl);
