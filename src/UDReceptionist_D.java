...
public class UDReceptionist_D extends JFrame {
    ...
    public static void main(String[] args) {
        UDReceptionist_D frame = new UDReceptionist_D();
        frame.setVisible(true);
    }


    public UDReceptionist_D() {
    ...
    private void initComponents() {
        ...
        updatelbl.setBounds(227, 191, 210, 40);
        PUD.add(updatelbl);
        ...
        emailfld.setBounds(227, 318, 154, 30);
        PUD.add(emailfld);
        ...
        Uemaillbl.setBounds(53, 322, 145, 22);
        PUD.add(Uemaillbl);
        ...
        updatebtn.addActionListener(new ActionListener() {
            public void actionPerformed(ActionEvent e) {
                try {
                    if (UpdateAll.updaterecep(Integer.parseInt(Uidfld.getText()),emailfld.getText())){
        ...
        updatebtn.setBounds(226, 374, 110, 30);
        PUD.add(updatebtn);
        ...
        btnDelete.addActionListener(new ActionListener() {
            public void actionPerformed(ActionEvent e) {
                try {
                    if (DeleteAll.deleterecep(Integer.parseInt(Didfld.getText()))){
        ...
        Receptionistlbl.setFont(new Font("Tahoma", Font.BOLD | Font.ITALIC, 22));
        Receptionistlbl.setBounds(572, 151, 245, 40);
        PUD.add(Receptionistlbl);
