...
public class UDDeliMan_D extends JFrame {
    ...
    public static void main(String[] args) {
        UDDeliMan_D frame = new UDDeliMan_D();
    ...
    private void initComponents() {
        ...
        updatebtn.addActionListener(new ActionListener() {
            public void actionPerformed(ActionEvent e) {
                try {
                    if (UpdateAll.updatedeliman(Integer.parseInt(Uidfld.getText()),emailfld.getText())){
        ...
        btnDelete.addActionListener(new ActionListener() {
            public void actionPerformed(ActionEvent e) {
                try {
                    if (DeleteAll.deletedeliman(Integer.parseInt(Didfld.getText()))){
